<div class="space-y-5">
    ...
    <div class="overflow-hidden ring-1 ring-zinc-200 dark:ring-zinc-700 sm:rounded-lg bg-white dark:bg-zinc-800">
        <div class="px-4 py-5 sm:px-6 border-b border-zinc-200 dark:border-zinc-700 flex items-center justify-between">
            <div>
                <flux:heading size="lg" class="text-zinc-900 dark:text-zinc-100">{{ __('Emergency Contact') }}</flux:heading>
                <p class="mt-1 text-sm text-zinc-500 dark:text-zinc-400">{{ __('Person to contact in case of emergency') }}</p>
            </div>
            <flux:button size="sm" variant="ghost" icon="pencil" wire:click="$dispatch('edit-emergency-contact')">
                {{ __('Edit') }}
            </flux:button>
        </div>
